...
public class Mosquito {
	...
	private int speed = 2; //값 변경 필요
	private int walkTempo = 10; //값 변경 필요
	...
	public void update() {
		...
		if(timeoutForMoving == 0) {
			...
			this.move(dx,dy);
			timeoutForMoving = rand.nextInt(60)+60; //값 변경 필요
		}
